...
public class HandleClickShow implements EventHandler<MouseEvent> {

    private TextField txtSquare1, txtSquare2, txtSquare3, txtSquare4, txtSquare5, txtSquare6, txtSquare7, txtSquare8, txtSquare9;
    private Label lblResult, lblrow1, lblrow2, lblrow3, lblcolumn1, lblcolumn2, lblcolumn3;
    ...
    public void handle (MouseEvent event){
        ...
        isInt(txtSquare7.getText()) || isInt(txtSquare8.getText()) || isInt(txtSquare9.getText())){
            ...
            lblrow1.setText(""+row1);
            lblrow2.setText(""+row2);
            lblrow3.setText(""+row3);
            lblcolumn1.setText(""+column1);
            lblcolumn2.setText(""+column2);
            lblcolumn3.setText(""+column3);

            if(Integer.parseInt(txtSquare1.getText()) == 0 || Integer.parseInt(txtSquare2.getText()) == 0 ||
